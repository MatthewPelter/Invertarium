<?php
    ...
    if(isset($_POST)){
        ...
        $result = mysqli_query($db_handle->conn,"SELECT * FROM user WHERE user_username = '$user_username'");
        if( mysqli_num_rows($result) > 0) {
            mysqli_query($db_handle->conn,$sql3)or die(mysqli_error($db_handle->conn));
