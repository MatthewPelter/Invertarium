<form action="components/update-profile.php" method="post" enctype="multipart/form-data" id="UploadForm">
                    ...
                    <br> 
                            ...
                            <br> 
                            <img style="height:300px; width: 300px;" src="userfiles/avatars/<?php echo $rws['user_avatar'];?>" class="img-responsive">
                ...
                <fieldset disabled> 
                    ...
                    <label for="">Bio</label>
                    <br> 
                    <textarea class="form-control" placeholder="<?php echo $rws['user_shortbio'];?>" cols="50" rows="10" placeholder="<?php echo $rws['user_shortbio'];?>" name="user_shortbio" value="<?php echo $rws['user_shortbio'];?>"><?php echo $rws['user_shortbio'];?></textarea>
                    <br> 
                ...
                <label><input type="radio" name="user_gender" id="optionsRadios1" value="Male" checked>Male</label>

                <label><input type="radio" name="user_gender" id="optionsRadios1" value="Female">Female</label>
                    <br> 
                    <label for="">Country</label>
                    <select name="country" value="<?php echo $rws['user_country'];?>">
                    ...
                    <input type="text" class="form-control" placeholder="<?php echo $rws['user_location'];?>" name="user_address" value="<?php echo $rws['user_location'];?>">    
                    <br> 
