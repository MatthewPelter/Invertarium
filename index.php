...
<html lang="en">
<head>
	<title>Invertarium Register</title>
	<meta charset="UTF-8">
...
<div class="wrapper">
	<div class="container">
		...
		<form class="form" action="components/registration.php" method="post" autocomplete="off">
			...
			<button type="submit" id="SubmitButton" value="Upload" name="signup_button" class="signin">Register</button><br />
			<a href="login.php"><button type="button" id="loginButton" value="log" name="loginbutton" class="log">Login</button></a>
		</form>
	</div>
